...
<div class="col-xs-12 col-md-8 " >
    ...
    <div class="row">
        ...
        <!--BOTÓN QUITAR FILTRO-->
        <a class="btn btn-warning btn-outline"  href="index.php?controller=notification&action=show">
            <i class="fa fa-search-minus"></i>
            <?php echo $strings['clean'];?>
        </a>
        <!--BOTÓN BUSCAR-->
        <a class="btn btn-primary" href="index.php?controller=notification&action=search">
        ...
        <?php if ($add) {
            echo '  
                            <a href="index.php?controller=notification&action=add">
    ...
    <div class="row" style="margin-top: 20px">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $strings['list_of'].' '.$strings['NOTIFICATION']; ?>
            ...
            <div class="panel-body">
                <table id="dataTable" class="table-responsive   table-hover" style="width:80%; margin-right: 10%; margin-left: 10%">
                    ...
                    <tr class="row" >
                        ...
                        <th class="text-center"><?php echo $strings['description']?></th>
                        <th class="text-center"><?php echo $strings['one_user']?></th>
                        <?php
                        if(!$edit && !$delete && !$v){ ?>
                            <th class="text-center"><?php echo $strings['no_notifications_to_do']?></th>
                            <?php
                        }else{
                            ?>
                    ...
                    foreach ($notifications as $c) {
                        ...
                        if($edit){
                            ...
                            echo "<a href=index.php?controller=notification&action=edit&codnotification=". $c->getCodnotification().'>';
                        ...
                        if($delete){
                            ...
                            echo '" data-toggle="modal" data-target="#confirmar'.$c->getCodnotification().'">';
