...
$spaces = $view->getVariable("spacestoshow");
...
<div class="col-xs-12 col-md-8 ">
    ...
    <div class="row">
        ...
        <!--BOTÓN QUITAR FILTRO-->
        <a class="btn btn-warning btn-outline"  href="index.php?controller=space&action=show">
            <i class="fa fa-search-minus"></i>
            <?php echo $strings['clean'];?>
        </a>
        <!--BOTÓN BUSCAR-->
        <a class="btn btn-primary" href="index.php?controller=space&action=search">
        ...
        <?php if ($add) {
            echo '  
                            <a href="index.php?controller=space&action=add">
    ...
    <div class="row" style="margin-top: 20px">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $strings['list_of'].' '.$strings['SPACE']; ?>
            ...
            <div class="panel-body">
                <table id="dataTable" class="table-responsive   table-hover" style="width:80%; margin-right: 10%; margin-left: 10%">
                    ...
                    //Para cada espazo, imprimimos o seu nome e as accións que se poden realizar nel (view,edit e delete)
                    foreach ($spaces as $c) {
                        ...
                        if($v){
                            ...
                            echo '" data-toggle="modal" data-target="#view'. $c->getCodspace(). '';
                        ...
                        if($edit){
                            ...
                            echo "<a href=index.php?controller=space&action=edit&id_espacio=". $c->getCodspace().'>';
                        ...
                        if($delete){
                            ...
                            echo '" data-toggle="modal" data-target="#confirmar'.$c->getCodspace().'';
                            echo '" style="margin:2px">';
