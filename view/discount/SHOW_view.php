...
<div class="col-xs-12 col-md-8 ">
    ...
    <div class="row">
        ...
        <!--BOTÓN QUITAR FILTRO-->
        <a class="btn btn-warning btn-outline" href="index.php?controller=discount&action=show">
            <i class="fa fa-search-minus"></i>
            <?php echo $strings['clean']; ?>
        </a>
        <!--BOTÓN BUSCAR-->
        <a class="btn btn-primary" href="index.php?controller=discount&action=search">
        ...
        <?php if ($add) {
            echo '  
                <a href="index.php?controller=discount&action=add">
                ...
                <table id="dataTable" class="table-responsive   table-hover"
                    ...
                    foreach ($discounts as $c) {
                        ...
                        if ($v) {
                            ...
                            echo '" data-toggle="modal" data-target="#view' . $c->getCoddiscount() . '">';
                        ...
                        if ($edit) {
                            ...
                            echo "<a href=index.php?controller=discount&action=edit&coddiscount=" . $c->getCoddiscount() . '>';
                        ...
                        if ($delete) {
                            ...
                            echo '" data-toggle="modal" data-target="#confirmar' . $c->getCoddiscount() . '">';
