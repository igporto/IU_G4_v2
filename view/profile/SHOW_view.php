...
include(__DIR__."/../../view/layouts/show_flag_setter.php");
    ...
    $permissions = $view->getVariable("profilestoshow"); 
...
<h1 class="page-header"><?php echo $strings['management_profiles'] ?></h1>
    ...
    <div class="row">
            ...
            <!--BOTÓN QUITAR FILTRO-->               
                    <a class="btn btn-warning btn-outline"  href="index.php?controller=profile&action=show">
                                <i class="fa fa-search-minus"></i>
                                <?php echo $strings['clean'];?>
                    </a>
                <!--BOTÓN BUSCAR-->
                    <a class="btn btn-primary" href="index.php?controller=profile&action=search">
                            ...
                            <table id="dataTable" class="table-responsive   table-hover" style="width:80%; margin-right: 10%; margin-left: 10%">
                                ...
                                foreach ($permissions as $c) {
                                   echo "<tr class='row text-center' ><td> ";
                                    ...
                                    echo $c->getProfilename()."</td><td class='text-center'>";
                                    //Botón que direcciona a vista do usuario
                                    if($v){
                                        echo '<button type="button" class="btn btn-primary btn-xs';
                                        echo '" data-toggle="modal" data-target="#view'.$c->getProfilename().'';
