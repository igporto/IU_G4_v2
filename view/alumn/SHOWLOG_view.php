...
foreach ($permissions as $perm){
    ...
    if($perm->getController()->getControllername() == "INJURY"){
...
$alumns = $view->getVariable("alumnstoshow");
?>

<div class="col-xs-12 col-md-8 ">

    <h1 class="page-header"><?php echo $strings['management_alumns'] ?></h1>
    ...
    <div class="row">
        ...
        <?php if ($add) {
            echo '  
                <a href="index.php?controller=alumn&action=add">
    ...
    <div class="row" style="margin-top: 20px">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $strings['list_of'] . ' ' . $strings['ALUMN']; ?>
            ...
            <div class="panel-body">
                <table id="dataTable" class="table-responsive   table-hover"
                    ...
                    foreach ($alumns as $c) {
                        ...
                        echo $c->getAlumnname()." ".$c->getAlumnsurname() . "</td><td>";
                        ...
                        if ($v) {
                            ...
                            echo '" data-toggle="modal" data-target="#view' . $c->getCodalumn() . '">';
                        ...
                        if ($edit) {
                            ...
                            echo "<a href=index.php?controller=alumn&action=edit&codalumn=" . $c->getCodalumn() . '>';
                        ...
                        if ($delete) {
                            ...
                            echo '" data-toggle="modal" data-target="#confirmar' . $c->getCodalumn() . '">';
