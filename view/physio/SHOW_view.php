...
$physios = $view->getVariable("physiostoshow");
?>

<div class="col-xs-12 col-md-8 ">

    <h1 class="page-header"><?php echo $strings['management_physios'] ?></h1>

    <div class="row">

        <!--BOTÓN QUITAR FILTRO-->
        <a class="btn btn-warning btn-outline" href="index.php?controller=physio&action=show">
            <i class="fa fa-search-minus"></i>
            <?php echo $strings['clean']; ?>
        </a>
        <!--BOTÓN BUSCAR-->
        <a class="btn btn-primary" href="index.php?controller=physio&action=search">
        ...
        <?php if ($add) {
            echo ' 
                <a href="index.php?controller=physio&action=add">
    ...
    <div class="row" style="margin-top: 20px">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $strings['list_of'] . ' ' . $strings['physio']; ?>
            ...
            <div class="panel-body">
                <table id="dataTable" class="table-responsive   table-hover"
                    ...
                    <tr class="row">
                        ...
                        <th class="text-center"><?php echo $strings['codPhysio'] ?></th>
                        <th class="text-center"><?php echo $strings['date'] ?></th>
                        <th class="text-center"><?php echo $strings['one_reserve'] ?></th>
                    ...
                    <?php
                    //Para cada physio, imprimimos o seu nome e as accións que se poden realizar nel (view,edit e delete)
                    foreach ($physios as $c) {
                        ...
                        if ($v) {
                            ...
                            echo '" data-toggle="modal" data-target="#view' . $c->getCodPhysio() . '">';
                            echo '<i class="fa fa-eye fa-fw"></i>
                                        </button>';
                        }
                        //Botón que direcciona á vista do editar
                        if ($edit) {
                            echo "<a href=index.php?controller=physio&action=edit&codPhysio=" . $c->getCodPhysio() . '>';
                        ...
                        if ($delete) {
                            ...
                            echo '" data-toggle="modal" data-target="#confirmar' . $c->getCodPhysio() . '">';
