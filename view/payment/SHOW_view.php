            ...
            <div class="panel-body">
                <table id="dataTable" class="table-responsive   table-hover"
                    ...
                    foreach ($permissions as $c) {
                        ...
                        echo $c->getPaymentname() . "</td><td class='text-center'>";
                        //Botón que direcciona a vista do usuario
                        if ($v) {
                            echo '<button type="button" class="btn btn-primary btn-xs';
                            echo '" data-toggle="modal" data-target="#view' . $c->getPaymentname() . '';
                        ...
                        if ($edit) {
                            ...
                            if ($c->getPaymentname() == "admin") {

                                echo "<button class='btn btn-warning btn-xs disabled";
                                echo "' style='margin:2px'>";
                                echo "<i class='fa fa-edit fa-fw'></i></button>";
                            } else {
                                echo "<a href=index.php?controller=payment&action=edit&payment_id=" . $c->getCodpayment() . '>';
                        ...
                        if ($delete) {
                            ...
                            if ($c->getPaymentname() == "admin") {
                                ...
                                echo '<button type="button" class="btn btn-danger btn-xs';
                                echo '" data-toggle="modal" data-target="#confirmar' . $c->getCodpayment() . '';
                                echo '" style="margin:2px">';
                                echo '<i class="fa fa-trash-o fa-fw"></i>
                                            </button>';
                            }
