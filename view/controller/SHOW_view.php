...
<h1 class="page-header"><?php echo $strings['management_controllers'] ?></h1>
    ...
    <div class="row">
            ...
            <!--BOTÓN QUITAR FILTRO-->               
                    <a class="btn btn-warning btn-outline"  href="index.php?controller=controller&action=show">
                                <i class="fa fa-search-minus"></i>
                                <?php echo $strings['clean'];?>
                    </a>
                <!--BOTÓN BUSCAR-->
                    <a class="btn btn-primary" href="index.php?controller=controller&action=search">
                            ...
                            <table id="dataTable" class="table-responsive   table-hover" style="width:80%; margin-right: 10%; margin-left: 10%">
                                ...
                                foreach ($controllers as $c) {
                                    ...
                                    if($v){
                                        ...
                                        echo '" data-toggle="modal" data-target="#view'.$c->getControllername().'">';
                                    ...
                                    if($edit){
                                        ...
                                        echo "<a href=index.php?controller=controller&action=edit&controllerName=". $c->getControllername().'>';
