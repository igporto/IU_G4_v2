...
<script>
    function enviar() {
        var ruta = 'index.php?controller=user&action=add';
        var query = '&perf_id=';
        var perfil = document.getElementById("perf_id").value;

        var parte2 = query.concat(perfil);
        window.location.href = ruta.concat(parte2);
    }
</script>

<div class="col-md-12" style="margin-bottom: 30px">
    <h1 class="page-header"><?php echo $strings['create_user']; ?></h1>
    <form name="form" id="form" method="POST" 
          action="index.php?controller=user&action=add"
          enctype="multipart/form-data">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <?php echo $strings['create_user'] ?>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12  col-md-5 pull-right">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input autofocus required class="form-control" type="username" name="username" placeholder="<?php echo $strings['name'];?>" >
                        </div>
                    </div>
                        <!--Campo name-->
                </div>
                <div class="row">
                    <div class="col-xs-12  col-md-5 pull-right">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input required class="form-control" type="password" name="password" placeholder="<?php echo $strings['pass'];?>">
                        </div>
                    </div>
                        <!--Campo name-->
                </div>
