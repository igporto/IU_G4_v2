...
<h1 class="page-header"><?php echo $strings['management_services'] ?></h1>
    ...
    <div class="row">
            ...
            <!--BOTÓN QUITAR FILTRO-->               
                    <a class="btn btn-warning btn-outline"  href="index.php?controller=service&action=show">
                                <i class="fa fa-search-minus"></i>
                                <?php echo $strings['clean'];?>
                    </a>
            <!--BOTÓN BUSCAR-->
                    <a class="btn btn-primary" href="index.php?controller=service&action=search">
            ...
            <?php if ($add) {
                echo '  
                            <a href="index.php?controller=service&action=add">
...
<div class="panel panel-default">
                        <div class="panel-heading">
                            <?php echo $strings['list_of'].' '.$strings['SERVICE']; ?>
                            ...
                            <table id="dataTable" class="table-responsive   table-hover" style="width:80%; margin-right: 10%; margin-left: 10%">
                                ...
                                foreach ($services as $c) {
                                    ...
                                    if($v){
                                        ...
                                        echo '" data-toggle="modal" data-target="#view'.$c->getId().'">';
                                    ...
                                    if($edit){
                                        ...
                                        echo "<a href=index.php?controller=service&action=edit&service_id=". $c->getId().'>';
                                    ...
                                    if($delete){
                                        ...
                                        echo '" data-toggle="modal" data-target="#confirmar'.$c->getId().'">';
