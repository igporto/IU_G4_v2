...
<div class="col-md-12 " style="margin-top: 20px">
    <h1 class="page-header"><?php echo $strings['search'].' '.$strings['SERVICE'] ; ?></h1>
    <form name="form" id="form" method="POST" onsubmit="return hasWhiteSpace()"
          action="index.php?controller=service&action=search"
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-5 pull-right">
                        <div class="form-group input-group">
                            ...
                            <input autofocus type="date" class="form-control" id="fecha" name="fecha" maxlength="25"
