...
<div class="col-xs-12 ">
    ...
    <h1 class="page-header"><?php echo $strings['management_activities'] ?></h1>

    <div class="row">

        <!--BOTÓN QUITAR FILTRO-->
        <a class="btn btn-warning btn-outline" href="index.php?controller=activity&action=show">
            <i class="fa fa-search-minus"></i>
            <?php echo $strings['clean']; ?>
        </a>
        <!--BOTÓN BUSCAR-->
        <a class="btn btn-primary" href="index.php?controller=activity&action=search">
    ...
    <div class="row" style="margin-top: 20px">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $strings['list_of'] . ' ' . $strings['ACTIVITY']; ?>
                ...
                <table id="dataTable" class="table-responsive   table-hover"
                    ...
                    foreach ($activities as $c) {
                        ...
                        if ($v) {
                            ...
                            echo '" data-toggle="modal" data-target="#view' . $c->getCodactivity() . '">';
                        ...
                        if ($edit) {
                            ...
                            echo "<a href=index.php?controller=activity&action=edit&codactivity=" . $c->getCodactivity() . '>';
                        ...
                        if ($delete) {
                            ...
                            echo '" data-toggle="modal" data-target="#confirmar' . $c->getCodactivity() . '">';
