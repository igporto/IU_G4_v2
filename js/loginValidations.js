//Animaciones selección de la campo contraseña.
function selPass() {
    //Borrar el mensaje
    ...
    document.getElementById("usrImg").style.color = "#999"

    document.getElementById("password").style.border = "none";
    document.getElementById("password").style.borderBottom = "2px solid #10CE88";
...
function selUsr() {
    ...
    document.getElementById("password").style.border = "none";
    document.getElementById("password").style.borderBottom = "2px solid #ddd";
    document.getElementById("password").style.borderRadius = "0px";
    document.getElementById("lock").style.color = "#999";

    document.getElementById("userName").style.border = "none";
    document.getElementById("userName").style.borderBottom = "2px solid #10CE88";
    document.getElementById("usrImg").style.color = "#10CE88"
}
